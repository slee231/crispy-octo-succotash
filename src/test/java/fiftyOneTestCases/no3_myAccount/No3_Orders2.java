...
//		3) Click on My Account Menu
		WebElement myAccount11 = driver.findElement(By.xpath("//a[text()='My Account']"));
		myAccount11.click();
...
//		4) Enter registered username in username textbox
		WebElement userNameBox11 = driver.findElement(By.xpath("//*[@id='username']"));
		userNameBox11.clear();
		userNameBox11.sendKeys("testing321@gmail.com");
		
//		5) Enter password in password textbox
		WebElement pwdBox11 = driver.findElement(By.xpath("//*[@id='password']"));
		pwdBox11.clear();
		pwdBox11.sendKeys("testemail321.");
...
//		10) Click view button
		// There is no "view button" to click
